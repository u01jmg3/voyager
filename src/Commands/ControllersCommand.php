...
class ControllersCommand extends Command
{
    ...
    {
        $stub = $this->getStub();
        $files = $this->filesystem->files(base_path('vendor/u01jmg3/voyager/src/Http/Controllers'));
    ...
    {
        return $this->filesystem->get(base_path('/vendor/u01jmg3/voyager/stubs/'.$this->stub));
    }
